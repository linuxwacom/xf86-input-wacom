 ...
 *
 *    v1.40-2.6.6-dwb-0.1 - incorporate with 2.6.6
 *    v1.40-2.6.6-pc-0.2  - added Intuos3
 *    v1.40-2.6.6-pc-0.3  - linuxwacom-0.6.6
 *    v1.40-2.6.6-pc-0.4  - fixed a Graphire bug
 *    v1.40-2.6.6-pc-0.5  - added Cintiq 21UX
 *    v1.40-2.6.6-pc-0.6  - fixed an I3 bug
 *    v1.40-2.6.6-pc-0.7  - fixed a Cintiq 21UX bug
 *    v1.40-2.6.6-pc-0.8  - Added G4, DTF720 and DTU710
 *    v1.40-2.6.6-pc-0.9  - Added DTF 521, I3 12x12, and I3 12x19
 */
 ...
 * Version Information
 */
#define DRIVER_VERSION "v1.40 - 2.6.6-pc-0.9"
