 ...
 *
 *    v1.40-2.6.4-pc-0.1 - incorporate with 2.6.4
 *    v1.40-2.6.4-pc-0.2 - linuxwacom-0.6.6
 *    v1.40-2.6.4-pc-0.3 - fixed a Graphire bug
 *    v1.40-2.6.4-pc-0.4 - added Cintiq 21UX
 *    v1.40-2.6.4-pc-0.5 - fixed an I3 bug
 *    v1.40-2.6.4-pc-0.6 - fixed a Cintiq 21UX bug
 *    v1.40-2.6.4-pc-0.7 - Added G4, DTF720 and DTU710
 *    v1.40-2.6.4-pc-0.8 - added DTF 521, I3 12x12, and I3 12x19
 */
 ...
 * Version Information
 */
#define DRIVER_VERSION "v1.40 - 2.6.4-pc-0.8"
...
static void wacom_ptu_irq(struct urb *urb, struct pt_regs *regs)
{
	...
	input_report_abs(dev, ABS_MISC, id); /* report tool id */
	input_report_abs(dev, ABS_X, le16_to_cpu(get_unaligned((u16 *) &data[2])));
	input_report_abs(dev, ABS_Y, le16_to_cpu(get_unaligned((u16 *) &data[4])));
	input_report_abs(dev, ABS_PRESSURE, le16_to_cpu(get_unaligned((u16 *) &data[6])));
