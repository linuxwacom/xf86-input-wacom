 ...
 *    v1.40-2.6.9-pc-0.3 - fixed a Graphire bug
 *    v1.40-2.6.9-pc-0.4 - added Cintiq 21UX
 *    v1.40-2.6.9-pc-0.5 - fixed an I3 bug
 *    v1.40-2.6.9-pc-0.6 - fixed a Cintiq 21UX bug
 ...
 *    v1.40-2.6.9-pc-0.15 - Fixed an expresskey bug
 */
