 ...
 *
 *    v1.40-2.6.5-pc-0.1 - incorporate with 2.6.5
 *    v1.40-2.6.5-pc-0.2 - linuxwacom-0.6.6
 *    v1.40-2.6.5-pc-0.3 - fixed a Graphire bug
 */
 ...
 * Version Information
 */
#define DRIVER_VERSION "v1.40 - 2.6.5-pc-0.3"
