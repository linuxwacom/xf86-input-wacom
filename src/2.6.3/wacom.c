 ...
 *
 *    v1.40-2.6.3-pc-0.1 - incorporate with 2.6.3
 *    v1.40-2.6.3-pc-0.2 - linuxwacom-0.6.6
 *    v1.40-2.6.3-pc-0.3 - fixed a Graphire bug
 *    v1.40-2.6.3-pc-0.4 - added Cintiq 21UX
 *    v1.40-2.6.3-pc-0.5 - fixed an I3 bug
 *    v1.40-2.6.3-pc-0.6 - fixed a Cintiq 21UX bug
 *    v1.40-2.6.3-pc-0.7 - Added G4, DTF720 and DTU710
 */
 ...
 * Version Information
 */
#define DRIVER_VERSION "v1.30.1 - 2.6.3-pc-0.7"
...
static void wacom_ptu_irq(struct urb *urb, struct pt_regs *regs)
{
	...
	{
		input_report_key(dev, BTN_TOOL_PEN, (data[1] & 0x20) ? ERASER_DEVICE_ID : 0);
