 ...
 *
 *    v1.43-2.6.14-pc-0.1 - initial release based on 2.6.14
 *    v1.43-2.6.14-pc-0.2 - added DTF 521, I3 12x12, and I3 12x19
 *    v1.43-2.6.14-pc-0.3 - Support tablet buttons/keys
 */
 ...
 * Version Information
 */
#define DRIVER_VERSION "v1.43-2.6.14-pc-0.3"
...
static int wacom_probe(struct usb_interface *intf, const struct usb_device_id *id)
{
	...
	switch (wacom->features->type) {
		...
		case INTUOS3S:
			wacom->dev.keybit[LONG(BTN_DIGI)] |= BIT(BTN_TOOL_FINGER);
			wacom->dev.keybit[LONG(BTN_LEFT)] |= BIT(BTN_1) | BIT(BTN_2) | BIT(BTN_3) | BIT(BTN_4);
