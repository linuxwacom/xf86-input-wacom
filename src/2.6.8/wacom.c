 ...
 *
 *    v1.40-2.6.8-pc-0.1 - incorporate with 2.6.8
 *    v1.40-2.6.8-pc-0.2 - linuxwacom-0.6.6
 *    v1.40-2.6.8-pc-0.3 - missed intuos_inout routine
 *    v1.40-2.6.8-pc-0.4 - fixed a Graphire bug
 *    v1.40-2.6.8-pc-0.5 - added Cintiq 21UX
 *    v1.40-2.6.8-pc-0.6 - fixed an I3 bug
 *    v1.40-2.6.8-pc-0.7 - fixed a Cintiq 21UX bug
 ...
 *    v1.40-2.6.8-pc-0.14 - Added Cintiq 20WSX
 */
 ...
 * Version Information
 */
#define DRIVER_VERSION "v1.40 - 2.6.8-pc-0.15"
