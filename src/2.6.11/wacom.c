 ...
 *    v1.40-2.6.11.3-pc-0.4 - Added G4, DTF720 and DTU710
 *    v1.40-2.6.11.3-pc-0.5 - added DTF 521, I3 12x12, and I3 12x19
 *    v1.40-2.6.11.3-pc-0.6 - Support tablet buttons/keys  
 */
 ...
 * Version Information
 */
#define DRIVER_VERSION "v1.40 - 2.6.11.3-pc-0.6"
